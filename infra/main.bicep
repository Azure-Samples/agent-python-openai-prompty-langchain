...
output AZURE_OPENAI_DEPLOYMENT string = deploymentName
...
output LANGCHAIN_APP_DEPLOYMENT_SCORING_ENDPOINT string = machineLearningEndpoint.outputs.scoringEndpoint
