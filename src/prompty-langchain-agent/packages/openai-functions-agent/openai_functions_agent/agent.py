...
if os.getenv('ELASTICSEARCH_ENDPOINT') is not None and os.getenv('ELASTICSEARCH_API_KEY') is not None and len(os.getenv('ELASTICSEARCH_ENDPOINT')) > 0 and len(os.getenv('ELASTICSEARCH_API_KEY')) > 0:
